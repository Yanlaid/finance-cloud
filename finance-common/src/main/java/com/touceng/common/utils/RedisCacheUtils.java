...
/**
 * 基于spring和redis的redisTemplate工具类 <br>
 * 针对所有的hash 都是以h开头的方法 <br>
 * 针对所有的Set 都是以s开头的方法 不含通用方法 <br>
 * 针对所有的List 都是以l开头的方法 <br>
 *
 * @author Wu, Hua-Zheng
 * @version v1.0.0
 * @classDesc: 功能描述: redis工具类
 * @createTime 2018年4月27日 下午2:23:23
...
//    }
    ...
    /**
     * 消息订阅
     * 默认全部采用StringSerializer
     * 消息的subscribe端也要对“发序列化”保持一致。
     *
     * @param channel 必须为string，而且“序列化”策略也是StringSerializer
     * @param message 消息内容，将会根据配置文件中指定的valueSerializer进行序列化
     */
