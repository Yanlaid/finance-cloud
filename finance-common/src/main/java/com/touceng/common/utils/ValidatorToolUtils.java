...
public final class ValidatorToolUtils {
    ...
    /**
     * 判断对象 <code>value</code> 是否不是null或者empty,调用 !{@link #Validator.isNullOrEmpty(Object)} 方法 .
     *
     * <p>
     * 示例参考 {@link #Validator.isNullOrEmpty(Object)} 方法
     * </p>
     *
     * <h3>对于empty的判断,使用以下逻辑:</h3>
     *
     ...
     * 如果是空也返回false<br>
     * 其他情况返回true<br>
     * @see #Validator.isNullOrEmpty(Object)
     */
